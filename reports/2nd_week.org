...
- Getting the conf.yaml right
  ...
  + I have to check how to use MariaDB/Galera with docker
    - [[https://blog.pythian.com/building-a-mariadb-galera-cluster-with-docker/][one tutorial]]
      ...
      - Ronan gave me the link to [[https://www.cockroachlabs.com/docs/stable/start-a-local-cluster-in-docker.html#os-linux][start a local cluster in docker]] and a lesson he did about Docker
